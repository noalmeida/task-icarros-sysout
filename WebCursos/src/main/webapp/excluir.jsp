					...
					BancoDeDados mysql = new BancoDeDados();
											...
											if(mysql.isConnected() && mysql.pesquisarCursos().size()!= 0){
												...
												for(Cursos c : listaRetornadaMysql ){
													...
													out.print("<td><form method=\"get\"><button type=\"submit\" name=\"submit\" class=\"btn btn-secondary\">Excluir</button></form></td>");
													out.print("</tr>");
													count++;
												}
												out.print("</tbody>");
												...
												out.print("<div class=\"row\">");
													...
													out.print("<br><br>");
													out.print("<p class=\"modal-text\">Não há cursos a serem excluidos.</p>");
													out.print("</div>");
													out.print("</div>");
